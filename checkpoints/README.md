...
Here is a demo to use CVTHead for cross-identity face reenactment after fine tuning
~~~
python inference.py --src_pth test/00086.png --ckpt_pth data/cvthead.pt --out_dir outputs
~~~
